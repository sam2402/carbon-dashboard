...
def get_carbon_coefficient(resource: GenericResource, carbon_per_kwh: int, interval: str) -> float:
    ...
    Args:
        resource (GenericResource): The resource information which is calculated to the carbon coefficient. 
    ...
    carbon_per_kws = carbon_per_kwh/(60*60)
    
    return power_watts * carbon_per_kws
...
class ResourceEmissionInfo:
    ...
    Attributes:
        ...
        power_consumption_breakdown (dict): A dictionary containing the power consumption breakdown information for that specific resource.
        fossil_free_percentage (int): The percentage of fossil-free energy used by the specific resource.
        renewable_percentage (int): The percentage of renewable energy used by the specific resource.
    """
